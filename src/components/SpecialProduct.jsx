...
const SpecialProduct = () => {
  return (
    <div className=" border-2 ring-black shadow-lg ring-1 rounded-lg">
      <div className="flex justify-between max-sm:flex-col max-lg:flex-col">
        ...
        <div className="rounded-lg py-4 px-2">
          <h6 className="text-red-800 text-sm">Iphone</h6>
          <h5 className="font-semibold text-lg py-2">
            Iphone 14 Pro max ags ádgasg
          </h5>
          <Rating
            name="size-small"
            readOnly={true}
          ...
          <div className="flex items-center p-3 gap-2">
            <p className="font-semibold text-lg">
              500&nbsp;<span className="opacity-70 text-base">Days</span>
            </p>
            <div className="flex items-center gap-2 font-semibold">
              <span className="rounded-full p-2 bg-red-600 text-white">12</span>
              :
              <span className="rounded-full p-2 bg-red-600 text-white">14</span>
              :
              <span className="rounded-full p-2 bg-red-600 text-white">60</span>
            </div>
          </div>
          <div>
